...
assignment/hello/hello.o: $(deps_assignment/hello/hello.o)

$(deps_assignment/hello/hello.o):

assignment/hello/hello.o: $(wildcard ./tools/objtool/objtool)
